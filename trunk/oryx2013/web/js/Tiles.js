...
var Tileset = {
	...
	dungeon: {
		...
		blood1: {img: "misc", subImg: new Position(6, 3), tileId: 11, getColor: getColor, color: {r:150,g:0,b:0}},
		blood2: {img: "misc", subImg: new Position(7, 3), tileId: 12, getColor: getColor, color: {r:150,g:0,b:0}},
		blood3: {img: "misc", subImg: new Position(8, 3), tileId: 13, getColor: getColor, color: {r:150,g:0,b:0}},
		blood4: {img: "misc", subImg: new Position(9, 3), tileId: 14, getColor: getColor, color: {r:150,g:0,b:0}},
