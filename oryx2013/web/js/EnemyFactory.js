var EnemyFactory = {
	enemies: {
		...
		thief: {name: msg.e.thief,   level: 3, hp: 45, str: 27, dfs: 25, spd: 28, exp: 25, money: 22, tile: "thief"},
		//Level 4
		fairy: {name: msg.e.fairy,       level: 4, hp: 46, str: 27, dfs: 25, spd: 28, exp: 27, money: 22, tile: "fairy"},
		...
		littleDemon: {name: msg.e.littleDemon,          level: 5, hp: 53, str: 35, dfs: 33, spd: 35, exp: 38, money: 35, tile: "littleDemon"},
		gelatinousCube: {name: msg.e.gelatinousCube,    level: 5, hp: 55, str: 38, dfs: 31, spd: 38, exp: 37, money: 37, tile: "gelatinousCube"},
		spore: {name: msg.e.spore,                      level: 5, hp:  50, str: 41, dfs: 35, spd: 38, exp: 40, money: 37, tile: "spore"},
		//Level 6
		...
		//Level 7
		giantSpider: {name: msg.e.giantSpider,   level: 7, hp: 65, str: 49, dfs: 45, spd: 45, exp: 50, money: 43, tile: "giantSpider"},
		bigSpore: {name: msg.e.bigSpore,         level: 7, hp: 68, str: 51, dfs: 47, spd: 47, exp: 52, money: 45, tile: "bigSpore"},
		humanRatMace: {name: msg.e.humanRatMace, level: 7, hp: 70, str: 53, dfs: 49, spd: 50, exp: 51, money: 48, tile: "humanRatMace"},
		warriorThief: {name: msg.e.warriorThief, level: 7, hp: 71, str: 55, dfs: 52, spd: 52, exp: 55, money: 50, tile: "warriorThief"},
		//Level 8
		...
		skeletonMaster: {name: msg.e.skeletonMaster,  level: 8, hp: 78, str: 59, dfs: 56, spd: 54, exp: 60, money: 56, tile: "skeletonMaster"},
		demon: {name: msg.e.demon,                    level: 8, hp: 80, str: 62, dfs: 59, spd: 57, exp: 62, money: 59, tile: "demon"},
		//Level 9
		...
		warriorFairy: {name: msg.e.warriorFairy,        level: 9, hp: 87, str: 66, dfs: 65, spd: 60, exp: 67, money: 65, tile: "warriorFairy"},
		lizardmenArcher: {name: msg.e.lizardmenArcher,  level: 9, hp: 90, str: 69, dfs: 66, spd: 62, exp: 69, money: 68, tile: "lizardmenArcher"},
		//Level 10
		spectreWizard: {name: msg.e.spectreWizard,   level: 10, hp: 92, str: 69, dfs: 66, spd: 63, exp: 71, money: 70, tile: "spectreWizard"},
		centaurArcher: {name: msg.e.centaurArcher,   level: 10, hp: 95, str: 71, dfs: 68, spd: 65, exp: 73, money: 72, tile: "centaurArcher"},
		...
		//Level 11
		mudMonster: {name: msg.e.mudMonster,       level: 11, hp: 102, str: 77, dfs: 71, spd: 68, exp: 78, money: 77, tile: "mudMonster"},
		...
		demonWarrior: {name: msg.e.demonWarrior,  level: 12, hp: 110, str: 85, dfs: 80, spd: 77, exp: 85, money: 88, tile: "demonWarrior"},
		mummy: {name: msg.e.mummy,                level: 12, hp: 112, str: 87, dfs: 81, spd: 80, exp: 87, money: 90, tile: "mummy"},
		echidna: {name: msg.e.echidna,            level: 12, hp: 114, str: 89, dfs: 83, spd: 81, exp: 89, money: 91, tile: "echidna"},
		//Level 13
		...
		scorpion: {name: msg.e.scorpion,               level: 13, hp: 123, str: 99, dfs: 90, spd: 89, exp: 95, money: 97, tile: "scorpion"},
		//Level 14 
		lycanthrope: {name: msg.e.lycanthrope,        level: 14, hp: 125, str: 102, dfs: 92, spd: 92, exp: 97, money: 97, tile: "lycanthrope"},
		skeletonArcher: {name: msg.e.skeletonArcher,  level: 14, hp: 127, str: 105, dfs: 94, spd: 95, exp: 97, money: 97, tile: "skeletonArcher"},
		golem: {name: msg.e.golem,                    level: 14, hp: 129, str: 107, dfs: 97, spd: 95, exp: 98, money: 99, tile: "golem"},
		beholder: {name: msg.e.beholder,              level: 14, hp: 131, str: 110, dfs: 99, spd: 97, exp: 99, money: 99, tile: "beholder"},
		//Level 15
		cyclops: {name: msg.e.cyclops,              level: 15, hp: 133, str: 113, dfs: 103, spd:  99, exp: 100, money: 100, tile: "cyclops"},
		...
		//Level 16
		demonArcher: {name: msg.e.demonArcher,            level: 16, hp: 142, str: 122, dfs: 110, spd: 107, exp: 105, money: 105, tile: "demonArcher"},
		entGolem: {name: msg.e.entGolem,                  level: 16, hp: 145, str: 125, dfs: 112, spd: 108, exp: 107, money: 105, tile: "entGolem"},
		superiorBeholder: {name: msg.e.superiorBeholder,  level: 16, hp: 147, str: 126, dfs: 114, spd: 110, exp: 108, money: 107, tile: "superiorBeholder"},
		GolemRat: {name: msg.e.GolemRat,                  level: 16, hp: 150, str: 127, dfs: 115, spd: 112, exp: 109, money: 110, tile: "GolemRat"},
		//Level 17
		dragon: {name: msg.e.dragon,                   level: 17, hp: 153, str: 127, dfs: 115, spd: 112, exp: 110, money: 112, tile: "dragon"},
		efreetWarrior: {name: msg.e.efreetWarrior,     level: 17, hp: 155, str: 128, dfs: 116, spd: 114, exp: 112, money: 114, tile: "efreetWarrior"},
		shadowWizard: {name: msg.e.shadowWizard,       level: 17, hp: 157, str: 130, dfs: 118, spd: 115, exp: 115, money: 115, tile: "shadowWizard"},
		centaurWarrior: {name: msg.e.centaurWarrior,   level: 17, hp: 160, str: 132, dfs: 120, spd: 117, exp: 116, money: 117, tile: "centaurWarrior"},
		//Level 18
		masterDemon: {name: msg.e.masterDemon,           level: 18, hp: 172, str: 135, dfs: 121, spd: 119, exp: 117, money: 117, tile: "masterDemon"},
		echidnaArcher: {name: msg.e.echidnaArcher,       level: 18, hp: 175, str: 136, dfs: 123, spd: 121, exp: 117, money: 119, tile: "echidnaArcher"},
		fenix: {name: msg.e.fenix,                       level: 18, hp: 176, str: 138, dfs: 125, spd: 123, exp: 119, money: 121, tile: "fenix"},
		superiorCyclops: {name: msg.e.superiorCyclops,   level: 18, hp: 178, str: 140, dfs: 126, spd: 125, exp: 121, money: 123, tile: "superiorCyclops"},
		//Level 19
		masterBeholder: {name: msg.e.masterBeholder,   level: 19, hp: 180, str: 142, dfs: 126, spd: 127, exp: 123, money: 125, tile: "masterBeholder"},
		ghostDragon: {name: msg.e.ghostDragon,         level: 19, hp: 182, str: 143, dfs: 127, spd: 130, exp: 126, money: 128, tile: "ghostDragon"},
		marid: {name: msg.e.marid,                     level: 19, hp: 185, str: 145, dfs: 129, spd: 132, exp: 128, money: 129, tile: "marid"},
		yonatan: {name: msg.e.yonatan,                 level: 19, hp: 188, str: 147, dfs: 131, spd: 135, exp: 131, money: 132, tile: "yonatan"},
	},
	
	bosses: {
		flameSkelleton: {name: msg.e.flameSkelleton,   level: 5,  hp:  70, str:  53, dfs:  49, spd:  50, exp: 101, money:  90, tile: "flameSkelleton"},
		incubus: {name: msg.e.incubus,                 level: 10, hp: 110, str:  85, dfs:  80, spd:  77, exp: 150, money: 130, tile: "incubus"},
		medusa: {name: msg.e.medusa,                   level: 15, hp: 153, str: 127, dfs: 115, spd: 112, exp: 200, money: 170, tile: "medusa"},
		Ias: {name: msg.e.Ias,                         level: 20, hp: 300, str: 250, dfs: 230, spd: 215, exp: 300, money: 300, tile: "Ias"},
	},
